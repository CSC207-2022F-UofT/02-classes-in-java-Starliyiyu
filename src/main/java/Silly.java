...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in 2 String objects as an argument.
     *
     * @param s1 a String for the first half of the instance's name.
     * @param s2 a String for the second half of the instance's name.
     */
